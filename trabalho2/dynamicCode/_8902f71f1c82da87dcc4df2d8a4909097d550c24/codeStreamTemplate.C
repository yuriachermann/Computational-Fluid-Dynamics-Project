...
extern "C"
{
    void codeStream_8902f71f1c82da87dcc4df2d8a4909097d550c24
    (
        Ostream& os,
...
pointField points(13);
        ...
        points[8]   = point(0,       200,    0.5);
        points[9]   = point(20,      200,    0.5);
        points[10]  = point(200,     200,    0.5);
        points[11]  = point(200,      10,    0.5);
        points[12]  = point(200,       0,    0.5);
