...
extern "C"
{
    void codeStream_0ffd6bd9a332bfce6f9987ac43e0d96a49451cf4
    (
        Ostream& os,
...
pointField points(13);
        ...
        points[8]   = point(0,       300,    0.5);
        points[9]   = point(20,      300,    0.5);
        points[10]  = point(300,     300,    0.5);
        points[11]  = point(300,      10,    0.5);
        points[12]  = point(300,       0,    0.5);
