...
extern "C"
{
    void codeStream_49193cb8b23425a89b3f775bf00963f4f973b89b
    (
        Ostream& os,
...
pointField points(13);
        ...
        points[8]   = point(0,       100,    0.5);
        points[9]   = point(20,      100,    0.5);
        points[10]  = point(100,     100,    0.5);
        points[11]  = point(100,      10,    0.5);
        points[12]  = point(100,       0,    0.5);
