...
extern "C"
{
    void codeStream_8b27f020df656048496b34d4972cecdc7e43de4c
    (
        Ostream& os,
...
pointField points(13);
        ...
        points[8]   = point(0,       600,    0.5);
        points[9]   = point(20,      600,    0.5);
        points[10]  = point(600,     600,    0.5);
        points[11]  = point(600,      10,    0.5);
        points[12]  = point(600,       0,    0.5);
